...
<div align="center">
  <video width="600" height="400" controls autoplay>
    <source src="[path_to_your_video.mp4](https://github.com/user-attachments/assets/c926e221-3da8-470b-9adc-f4a6b2fa3cd5)" type="video/mp4">
...
1. **Clone the Repository**:
   ```bash
   git clone https://github.com/sameph/Amharic_to_Ethiopian_sign_language_translator.git
...
5. **Access the App: Open your browser and go to http://127.0.0.1:5000 to start using the translator.**
...
This project integrates a FastText model trained specifically for Amharic text to ensure accurate word similarity, which enhances the translation results. The model has been fine-tuned to handle the nuances of the Amharic language.

## 📚 Usage

- **Translate Amharic Text**: Enter the text you wish to translate in the provided input box, and receive the corresponding Ethiopian Sign Language output.
- **Dictionary Functionality**: Search for specific words to see their translation in ESL.
